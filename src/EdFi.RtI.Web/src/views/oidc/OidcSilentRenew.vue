<template>
    <div style="background: rgb(255, 255, 255); background: linear-gradient(0deg, rgba(255, 255, 255, 1) 0%, rgba(226, 237, 255, 1) 100%);">
        <v-container class="d-flex justify-center align-center" style="height: 100vh">
            <v-card class="mx-auto" min-width="550" max-width="550" elevation="2">
                <v-card-text>
                    <v-row>
                        ...
                        <v-col cols="6">
                            <div class="pa-7">
                                <v-img contain class="my-3" height="130"
                        ...
                        <v-col cols="6">
                            <div class="d-flex justify-center align-center" style="height: 100%">
                                ...
                                <div v-if="isSigningIn" style="width: 100%;">
                                    <p class="text-center">Session Expired. Re-signing In...</p>
                                    <v-progress-linear indeterminate/>
                                </div>

                                <div v-if="isAccesingApp" style="width: 100%;">
                                    <p class="text-center">Session restoreed! Accesing App...</p>
                                    <v-progress-linear indeterminate/>
                                </div>

                                <div v-if="isShowingSignInError" style="width: 100%;">
                                    <h4 class="text-center mb-3">Could not restore session :(</h4>
                                    <v-btn block color="error" class="text-capitalize" @click="retrySignIn">Retry</v-btn>
                                </div>
...
export default {
    ...
    mounted() {
        console.log('OidcSilentRenew.mounted()');
        this.attemptSignIn();
    }, // mounted
    ...
    methods: {
        ...
        attemptSignIn() {
            ...
            vuexOidcProcessSilentSignInCallback(this.$config.auth)
            .then(() => {
