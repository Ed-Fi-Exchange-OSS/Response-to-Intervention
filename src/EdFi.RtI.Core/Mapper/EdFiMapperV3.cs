...
{
    public class EdFiMapperV3 : IEdFiMapper
    {
        ...
        {
            if (staff.IdentificationCodes != null)
            {
                staff.IdentificationCodes = staff.IdentificationCodes
                    .Where(obj => obj.StaffIdentificationSystemDescriptor != "SSN")
                    .ToList();
            }
